...
# https://store.nethunter.com.  It will automatically delete changes in this
...
# 2. the 'origin' remote is set to https://gitlab.com/kalilinux/nethunter/store/nethunter-store-website.git
